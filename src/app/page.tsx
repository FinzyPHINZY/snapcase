          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                Capture your favorite meories with your own,{" "}
              ...
              {/* Customers showcase */}
              <div className="mt-12 flex flex-col sm:flex-row items-cente sm:items-start gap-5">
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="tex-lg leading-8">
                <p>
                  ...
                  , on the case I had before, the image starterd fading into
                  yellow-ish color after a couple weels. Love it. &quot;
                </p>
              </div>
